        ...
        <div class="cart_check-wrapper">
            <div class="dform_outer">
                <div class="dform">
                    ...
                    <DeliverySelf ref="delSafe" v-if="showDeliverySelf && this.deliveryType === 'post'" type="post"
                                  text="Ранее используемый почтовый адрес"/>
                    <DeliverySelf ref="delSafe" v-if="showDeliverySelf && this.deliveryType === 'delivery'"
                                  type="delivery"
                                  text="Ранее используемый адрес доставки"/>
                    <DeliverySelf ref="delSafe" v-if="showDeliverySelf && this.deliveryType === 'deliveryMkad'"
                                  type="deliveryMkad" text="Ранее используемый адрес доставки"/>
...
export default {
    ...
    methods: {
        ...
        callPostForm() {
            return this.$refs.postRef.handleValidatePostForm();
        },
