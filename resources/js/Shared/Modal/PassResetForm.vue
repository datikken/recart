            ...
            <div class="passResetForm_inner">
                ...
                <form>
                    ...
                    <div class="form_group">
                        ...
                        <input class="form_group_input" type="password" name="new_password_confirm"
                    ...
                    <div class="form_group">
                        <!--@include('components.btn.text_btn', ['attr' => 'data-passResetBtn', 'class' => 'mauto yellow_btn-->
                        <!--animated_btn', 'text' => 'Отправить'])-->
                    </div>
