...
<head>
    ...
    {{--Fonts--}}
    <link rel="preload" href="/fonts/Montserrat-Medium.ttf&display=swap" as="font" type="font/ttf" crossorigin>
    <link rel="preload" href="/fonts/Montserrat-Regular.ttf&display=swap" as="font" type="font/ttf" crossorigin>
    <link rel="preload" href="/fonts/Montserrat-semibold.ttf&display=swap" as="font" type="font/ttf" crossorigin>
    {{--Favicon--}}
